        ...
        <>
            <section className="settings-section">
                ...
                <p className="section-description">
                    Toggle which providers are available for council members and the chairman.
                    <br /><em style={{ opacity: 0.7, fontSize: '12px' }}>Non-chat models (embeddings, image, speech, OCR) are filtered out.</em>
                </p>
